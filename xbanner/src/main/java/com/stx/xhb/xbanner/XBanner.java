...
//        Log.d("currentPos:" + currentPos, "getBannerCurrentItem:" + getBannerCurrentItem());
            ...
            switch (ev.getAction()) {
                ...
                case MotionEvent.ACTION_UP:
                    if (mIsClipChildrenMode) {
                        //点击banner左侧
                        if (clickPosition == 0) {
//                            Log.d("clickPosition:" + clickPosition, "getBannerCurrentItem():" + getBannerCurrentItem());
